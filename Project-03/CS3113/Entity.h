...
private:
    // Collision helpers
    Vector2 getMinOverlap(Map* map, std::vector<Vector2> probes,
...
protected:
    ...
    Vector2 mColliderOffset = {0.0f, 0.0f}; // added this
    ...
    void checkCollisions(Entity* collidableEntities, int collisionCheckCount);
...
public:
    ...
    virtual void update(float deltaTime, Entity* collidableEntities,
    ...
    bool isColliding() const {
        return mIsCollidingTop || mIsCollidingBottom || mIsCollidingRight
            || mIsCollidingLeft;
    }
